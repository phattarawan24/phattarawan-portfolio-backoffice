            ...
            <div class="row">
                <div class="col-xl">
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <form action="{{ route('profile.update', ['id' => $data->id]) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="mb-3">
                                    <label class="form-label" for="basic-default-first_name">First Name</label>
                                    <input type="text" class="form-control @error('first_name') is-invalid @enderror"
                                        name="first_name" id="basic-default-first_name" value="{{ old('first_name', $data->first_name) }}"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control  @error('last_name') is-invalid @enderror"
                                        name="last_name" value="{{ old('last_name', $data->last_name) }}" id="basic-default-last_name"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="basic-default-phone"
                                        ...
                                        value="{{ old('phone', $data->phone) }}" placeholder="088 799 8941" />
                                    @error('phone')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input id="basic-default-birthday"
                                        ...
                                        value="{{ old('birthday', $data->birthday) }}" placeholder="Birthday">
                                    @error('birthday')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input id="basic-default-degree"
                                        ...
                                        value="{{ old('degree', $data->degree) }}" placeholder="Degree">
                                    @error('degree')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input id="basic-default-experience"
                                        ...
                                        value="{{ old('experience', $data->experience) }}" placeholder="Experience">
                                    @error('experience')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
